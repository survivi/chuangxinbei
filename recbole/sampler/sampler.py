...
class AbstractSampler(object):
    ...
    def _sum_sampling(self, sample_num):
        """Sample [sample_num] items in the uniform distribution.
        ...
        Returns:
            sample_list (np.array): a list of samples.
        """
        raise NotImplementedError('Method [_constant_sampling] should be implemented')
    ...
    def sampling(self, sample_num):
        ...
        # elif self.distribution == 'sum':  # 随机采样某一数量的负样本，如100个
        #    return self._uni_sampling(sample_num)
        else:
...
class Sampler(AbstractSampler):
    ...
    def get_used_ids(self):
        ...
        # print('used_item_id',used_item_id)
        return used_item_id
