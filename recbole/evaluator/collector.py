...
class Collector(object):
    ...
    def data_collect(self, train_data):
        ...
        if self.register.need('data.count_users'):
            self.data_struct.set('data.count_users', train_data.dataset.user_counter)  # 用户交互频率
    ...
    def eval_batch_collect(
        ...
        if self.register.need('rec.topk'):
            ...
            pos_matrix[positive_u.type(torch.LongTensor), positive_i.type(torch.LongTensor)] = 1
